...
module.exports = RelationInspectorView = React.createClass
  ...
  renderTabforLink: (link) ->
    ...
    {vector, scalar, accumulator, transfer} = RelationFactory.selectionsFromRelation link.relation
    isFullyDefined = (link.relation.isDefined and vector? and scalar?) or link.relation.customData? or accumulator? or transfer?
