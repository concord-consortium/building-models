module.exports =
  ...
  "~NODE-VALUE-EDIT.RESTRICT_POSITIVE": "Can go below zero"  # TRANSLATE
  "~NODE-VALUE-EDIT.RESTRICT_POSITIVE_UNCHECKED_TOOLTIP": "Click to allow negative values"  # TRANSLATE
  "~NODE-VALUE-EDIT.RESTRICT_POSITIVE_CHECKED_TOOLTIP": "Click to prevent negative values"  # TRANSLATE
  "~NODE-VALUE-EDIT.RESTRICT_POSITIVE_DISABLED_TOOLTIP": "Disabled for all collectors by \"Limit values\" simulation setting"  # TRANSLATE
  ...
  "~SIMULATION.DIAGRAM_ONLY": "僅使用繪製模型工具"
