module.exports =
  ...
  "~NODE-VALUE-EDIT.RESTRICT_POSITIVE": "Cannot go below zero"
  "~NODE-VALUE-EDIT.RESTRICT_POSITIVE_CHECKED_TOOLTIP": "Click to allow negative values"
  "~NODE-VALUE-EDIT.RESTRICT_POSITIVE_UNCHECKED_TOOLTIP": "Click to prevent negative values"
  "~NODE-VALUE-EDIT.RESTRICT_POSITIVE_DISABLED_TOOLTIP": "Enabled for all collectors by \"Limit values\" simulation setting"
